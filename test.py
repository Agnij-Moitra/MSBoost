...
def regression_test():
    ...
    regressor = MSBoostRegressor(n_estimators=10, learning_rate=0.01, return_vals=True)
...
def classification_test():
    ...
    classifier = MSBoostClassifier(n_estimators=10, learning_rate=0.01, return_vals=True)
